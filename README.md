...
| resourceGroup       | x        | str                                      | <REPOSITORY_NAME> | The Azure resource group that contains the workspace. |
...
| createResourceGroup |          | bool                     | false       | Indicates whether to create the resource group if it doesn't exist. |
